...
{
    /// <summary>
    /// Lấy dữ liệu by where
    /// </summary>
    /// <param name="predicate"></param>
    /// <param name="disableTracking"></param>
    /// <returns></returns>
    IQueryable<TEntity> GetByWhere(Expression<Func<TEntity, bool>> predicate = null,
    ...
    /// <param name="disableTracking"></param>
    /// <returns></returns>
    IQueryable<TEntity> GetByWhereOrder(Expression<Func<TEntity, bool>> predicate = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null,
                                            bool disableTracking = true);

    /// <summary>
    /// Lấy dữ liệu theo takes
    /// </summary>
    /// <param name="predicate"></param>
    /// <param name="orderBy"></param>
    ...
    /// <param name="disableTracking"></param>
    /// <returns></returns>
    Task<IList<TEntity>> GetByTakeToListAsync(Expression<Func<TEntity, bool>> predicate = null
    ...
    /// </summary>
    /// <param name="entities">The entities.</param>
    void DeleteByWhere(Expression<Func<TEntity, bool>> predicate = null);

    TEntity FindOne(Expression<Func<TEntity, bool>> criteria = null);
